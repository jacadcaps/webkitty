...
public:
    ...
    void setFullscreenElement(WebCore::Element *, CompletionHandler<void(WebCore::ExceptionOr<void>)>&& willEnterFullscreen, CompletionHandler<bool(bool)>&& didEnterFullscreen);
    void clearFullscreenElement();
    void didEnterFullscreen(bool isFS);
...
private:
    ...
    CompletionHandler<bool(bool)> m_didEnterFullscreen;
#endif
};
