...
private:
	...
	Optional<CaptureDevice> captureDeviceWithPersistentID(CaptureDevice::DeviceType type, const String& id) final { return WTF::nullopt; }
};

class VideoCaptureDeviceManagerMorphOS final : public CaptureDeviceManager {
private:
	const Vector<CaptureDevice>& captureDevices() final { static Vector<CaptureDevice> vDummy; return vDummy; }
	Optional<CaptureDevice> captureDeviceWithPersistentID(CaptureDevice::DeviceType, const String&) final { return WTF::nullopt; }
};
